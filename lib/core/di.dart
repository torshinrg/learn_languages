...
import '../data/local/local_task_repo.dart'; // <-- new
...
import '../domain/repositories/i_task_repository.dart'; // <-- new
...
Future<Database> _initDatabase() async {
  ...
  final db = await openDatabase(
    ...
    onOpen: (db) async {
      // Ensure tasks table exists on open as well
      await db.execute('''
        CREATE TABLE IF NOT EXISTS tasks(
          id TEXT PRIMARY KEY,
          description TEXT NOT NULL,
